...
class UPDHandler(BaseDocumentHandler):
    ...
    FIELD_REGIONS = {
        ...
        'provider': ['Продавец', 'Поставщик', 'ИНН продавца', 'Грузоотправитель'],
        'customer': ['Покупатель', 'Получатель', 'ИНН покупателя', 'Грузополучатель'],
        'bank': [],
...
4. ИНН продавца
5. Наименование покупателя/получателя (полное)
6. ИНН покупателя
7. Основание (договор, контракт)
