...
class GLMOCRModel(BaseModel):
    ...
    def _get_russian_ocr_prompt(self) -> str:
        ...
        return """Выполните OCR (распознавание текста) с изображения.

ТРЕБОВАНИЯ К ВЫВОДУ:
1. Текст ТОЛЬКО на русском языке (а-яёА-ЯЁ)
2. Цифры ТОЛЬКО арабские (0-9)
3. НЕ добавляйте пояснения или комментарии
4. Таблицы в формате JSON-массива

ФОРМАТ ОТВЕТА:
{
    "text": "распознанный текст",
    "tables": [["столбец1", "столбец2"], ["данные", "данные"]]
}"""