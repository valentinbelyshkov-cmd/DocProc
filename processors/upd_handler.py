...
class UPDHandler(BaseDocumentHandler):
    ...
    REQUIRED_FIELDS = [
        ...
        },
        {
            ...
            'patterns': [
                r'(?:сде(?:л|u)тель/дата|дата/номер)\s*(?:№|no\.?|#)?\s*[:\-]?\s*(\S+)',
        ...
        },
        {
            'name': 'Дата документа',
            'patterns': [
                r'(?:сде(?:л|u)тель/дата|дата/номер|дата)\s*(?:№|#)?\s*\S+\s+от\s+(\d{1,2}(?:\s+[а-я]+\s+|\.|\/)\d{2,4}(?:\s*г\.)?)',
        ...
        },
        {
            'name': 'ИНН продавца',
            'patterns': [
                r'(?:инн|инкцип|iнн|инн/кпп|1нн)\s*(?:продавца|поставщика)?\s*[:\-]?\s*(\d{10})',
        ...
        },
        {
            'name': 'КПП продавца',
            'patterns': [
                r'(?:инн|инкцип|iнн|инн/кпп|1нн)\s*(?:продавца|поставщика)?\s*[:\-]?\s*\d{10}[/\\]?(\d{9})',
                r'(?:BIK|бик)\s*[:\-]?\s*(\d{9})/\d{10}',
                r'\b(\d{9})\b'
            ],
            'required': False,
        ...
        },
        {
            'name': 'ИНН покупателя',
            'patterns': [
                r'(?:инкцип|инн|iнн|инн/кпп|1нн)\s+(?:получатель|покупатель)\s*[:\-]?\s*(\d{10})',
        ...
        },
        {
            'name': 'КПП покупателя',
            'patterns': [
                r'(?:инкцип|инн|iнн|инн/кпп|1нн)\s+(?:получатель|покупатель)\s*[:\-]?\s*\d{10}[/\\]?(\d{9})',
                r'(?:инн|инкцип|iнн|инн/кпп|1нн)\s*(?:покупателя|получателя)?\s*[:\-]?\s*\d{10}[/\\]?(\d{9})',
                r'\b(\d{9})\b'
            ],
            'required': False,
            'region': 'customer'
    ...
    FIELD_REGIONS = {
        ...
        'provider': ['Продавец', 'ИНН продавца', 'КПП продавца', 'Грузоотправитель', 'Адрес поставщика'],
